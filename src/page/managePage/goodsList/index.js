...
import { Classify, Updown, ModalAdd, SelectAll } from './components/components';

//  商品管理
class GoodsManageContainer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            listState: false,
...
export default connect(mapStateToProps)(GoodsManageContainer);